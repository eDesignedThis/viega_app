...
function HandleWishlistAction(data) {
	if (data.Result == null || data.Result == "success") {
		...
		ShowWishListError(data.Result);
	}
}

function ShowWishListError(errorMessage) {
	getJson("SHOPPING.WISHLISTITEMS", HandleGetWishListItemsWithError);
	function HandleGetWishListItemsWithError(data) {
		HandleGetWishlist(data);
